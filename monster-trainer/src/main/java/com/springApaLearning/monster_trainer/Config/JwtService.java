...
public class JwtService {
    ...
    public String generateToken(String username) {
        ...
        claims.put("sub", userDetails.getUsername()); //subject
    ...
    public <T> T extractClaims (String token, Function<Claims, T> claimsResolver) { //extraction of tokens
    ...
    private String generateToken(Map<String,Object> claims, UserCredential userCredential) {
        ...
        return Jwts //creating jwt token from yaml
                .builder()
                .claims(claims)
